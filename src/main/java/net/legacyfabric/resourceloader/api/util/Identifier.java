package net.legacyfabric.resourceloader.api.util;
...
public class Identifier implements Comparable<Identifier> {
    ...
    private Identifier(String... pathParts) {
        this.namespace = StringUtils.isEmpty(pathParts[0]) ? "data/minecraft" : pathParts[0].toLowerCase(Locale.ROOT);
    ...
    protected static String[] parseString(String path) {
        String[] strings = new String[]{"data/minecraft", path};
