...
import net.legacyfabric.resourceloader.api.resource.ResourceManagerHelper;
...
public class ResourceManagerHelperImpl implements ResourceManagerHelper {
	...
	public static final Logger LOGGER = LogManager.getLogger(ResourceManagerHelperImpl.class);
