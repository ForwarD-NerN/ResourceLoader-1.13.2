...
public abstract class TranslationStorageMixin {
	...
	private static final boolean isUpperCase = false;

	private static final Gson GSON = new GsonBuilder().create();

	@Inject(method = "load(Lnet/minecraft/resource/ResourceManager;Ljava/util/List;)V", at = @At(value = "INVOKE",
			target = "Lnet/minecraft/client/resource/language/TranslationStorage;setRightToLeft()V"))
